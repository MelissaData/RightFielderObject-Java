...
public class MelissaRightFielderObjectWindowsJava {
  ...
  public static void RunAsConsole(String license, String testInput, String dataPath) throws IOException {
    System.out.println("\n\n=========== WELCOME TO MELISSA RIGHT FIELDER OBJECT WINDOWS JAVA ===========\n");
    ...
    while (shouldContinueRunning) {
      ...
      // System.out.println("\t Url: " + rightFielderObject.mdRightFielderObj.GetURL());
