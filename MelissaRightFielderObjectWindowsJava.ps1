...
javac -cp mdRightFielder.jar MelissaRightFielderObjectWindowsJava.java
jar cvfm MelissaRightFielderObjectWindowsJava.jar manifest.txt *.class *.dll mdRightFielder.jar
